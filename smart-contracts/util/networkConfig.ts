...
export const NETWORK_CONFIGS: Record<string, NetworkConfig> = {
  ...
  bsc: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0x2c34A2Fb1d0b4f55de51E1d0bDEfaDDce6b7cDD6",
        name: "OkxApproval",
        protocol: "okx",
      },
      {
  ...
  polygon: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0x3B86917369B83a6892f553609F3c2F439C184e31",
        name: "OkxApproval",
        protocol: "okx",
      },
      {
  ...
  blast: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0x5fD2Dc91FF1dE7FF4AEB1CACeF8E9911bAAECa68",
        name: "OkxApproval",
        protocol: "okx",
      },
    ],
  ...
  zksync: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0xc67879F4065d3B9fe1C09EE990B891Aa8E3a4c2f",
        name: "OkxApproval",
        protocol: "okx",
      },
    ],
  ...
  unichain: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0x2e28281Cf3D58f475cebE27bec4B8a23dFC7782c",
        name: "OkxApproval",
        protocol: "okx",
      },
    ],
  ...
  sonic: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0xd321ab5589d3e8fa5df985ccfef625022e2dd910",
        name: "OkxApproval",
        protocol: "okx",
      },
    ],
  ...
  plasma: {
    ...
    knownSwapTargets: [
      ...
      {
        address: "0x9FD43F5E4c24543b2eBC807321E58e6D350d6a5A",
        name: "OkxApproval",
        protocol: "okx",
      },
      {
